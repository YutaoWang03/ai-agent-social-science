...
## 案例 1（case1/documents/prompt-1.md）：ESG 与企业盈利能力的初版理论模型
...
## 案例 2（case2/documents/prompt-2.md）：ESG、融资约束与盈利能力的理论拓展

下面给你一个"ESG 直接影响企业盈利能力"的基准模型model_setup.md。请你完成以下任务：
1. 先给执行计划；
2. 在原模型中加入融资能力这一中介机制；
...
6. 给出至少一个新的比较静态结论；
7. 输出 `extension_notes.md` 和 `extension.lyx`；
8. 明确列出拓展后新增的假设以及它们的经济含义；
9. 最后指出这个拓展模型最容易出错的三步。

---

## 案例 3（case3/documents/prompt-3.md）：下载上市公司财务数据
...
## 案例 4（case4/documents/prompt-4.md）：从年报构造 ESG 面板
...
## 案例 5（case5/documents/prompt-5.md）：裁判文书数据库
...
## 案例 6（case6/documents/prompt-6.md）：ESG、融资约束与盈利能力的回归分析
...
## 案例 7（case7/documents/prompt-7.md）：简单 DSGE 模型
...
## 案例 8（case8/documents/prompt-8.md）：把理论与回归写成论文
...
## 案例 9（case9/documents/prompt-9.md）：修稿与回复审稿人
...
## 案例 10（case10/documents/prompt-10.md）：研究写作全流程整合
