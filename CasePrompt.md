...
## 案例 1（prompt-1.md）：ESG 与企业盈利能力的初版理论模型
...
## 案例 2（prompt-2.md）：ESG、融资约束与盈利能力的理论拓展
